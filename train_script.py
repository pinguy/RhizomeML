import os
# Replace "DavidAU/LFM2.5-1.2B-Instruct-Thinking-Claude-High-Reasoning" with any CAUSAL_LM model you want to finetune from HF. GTX 1660 Ti with 6GB of VRAM is able to finefune models 3b and under.
...
def determine_fan_in_fan_out(model_name: str) -> bool:
    ...
    Args:
        model_name: The model name or path (e.g., "DavidAU/LFM2.5-1.2B-Instruct-Thinking-Claude-High-Reasoning")
...
class RhizomeTrainer:
    ...
    """
    def __init__(self, model_name="DavidAU/LFM2.5-1.2B-Instruct-Thinking-Claude-High-Reasoning"):
...
def main():
    ...
    trainer = RhizomeTrainer(model_name="DavidAU/LFM2.5-1.2B-Instruct-Thinking-Claude-High-Reasoning")
